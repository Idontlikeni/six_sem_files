...
localparam [6:0] RES_A1 = 7'b0000111; // Последний адрес сообщения результата // поставить значения след. начала. (0000110)
...
always @*
    case(RES_CT)
        5'b00001: HEX_DATA  <= RES_REG[87:84];
        5'b00010: HEX_DATA  <= RES_REG[83:80];
        5'b00011: HEX_DATA  <= RES_REG[79:76];
        5'b00100: HEX_DATA  <= RES_REG[75:72];
        5'b00101: HEX_DATA  <= RES_REG[71:68];
        5'b00110: HEX_DATA  <= RES_REG[67:64];
        5'b00111: HEX_DATA  <= RES_REG[63:60];
        5'b01000: HEX_DATA  <= RES_REG[59:56];
        5'b01001: HEX_DATA  <= RES_REG[55:52];
        5'b01010: HEX_DATA  <= RES_REG[51:48];
        5'b01011: HEX_DATA  <= RES_REG[47:44];
        5'b01100: HEX_DATA  <= RES_REG[43:40];
        5'b01101: HEX_DATA  <= RES_REG[39:36];
        5'b01110: HEX_DATA  <= RES_REG[35:32];
        5'b01111: HEX_DATA  <= RES_REG[31:28];
        5'b10001: HEX_DATA  <= RES_REG[27:24];
        5'b10010: HEX_DATA  <= RES_REG[23:20];
        5'b10011: HEX_DATA  <= RES_REG[19:16];
        5'b10100: HEX_DATA  <= RES_REG[15:12];
        5'b10101: HEX_DATA  <= RES_REG[11:8];
        5'b10110: HEX_DATA  <= RES_REG[7:4];
...
always @(posedge clk, posedge rst)
    if(rst)
        begin
            ...
            TX_DATA_T <= 8'h0;
            TX_RDY_T <= 1'b0;    
            DATA_CT <= 3'b000; // (разрядность(1'b0))
            RES_CT <= 5'b00000;
            DATA_REG <= 0;
            RES_REG <= 0;
            ADDR <= 0;
