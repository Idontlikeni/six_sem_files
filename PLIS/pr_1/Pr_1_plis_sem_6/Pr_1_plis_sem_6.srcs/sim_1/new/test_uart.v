...
module test_uart();
    ...
    initial begin
        ...
        if (captured_en && captured_data[7:0] == 8'h41 && captured_data[8] == ~(^captured_data[7:0]) && captured_data[9] == 0) begin
        ...
        if (captured_en && captured_data[8] != ^captured_data[7:0]) begin
