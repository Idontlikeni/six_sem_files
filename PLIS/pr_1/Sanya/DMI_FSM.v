...
localparam [6:0] RES_A0 = 7'b0000000;// или wire [6:0] RES_A0; assign RES_A0 = 7'b0000000;
localparam [6:0] RES_A1 = 7'b0000110;// или wire [6:0] RES_A1; assign RES_A1 = 7'b0000110;
...
always @*
    case(RX_DATA_R[9:8])
        2'b00: begin
            ...
            ERR_A1_MX <= 7'b0011000;
        end
        2'b01: begin
            ERR_A0_MX <= 7'b0000000;
            ERR_A1_MX <= 7'b0000000;
        end
        2'b10: begin
            ERR_A0_MX <= 7'b0100110;
            ERR_A1_MX <= 7'b0110010;
        end
        default: begin
            ERR_A0_MX <= 7'b0110011;
            ERR_A1_MX <= 7'b1001001;
        end
    endcase
...
always @*
    case(RES_CT)
        5'b0000: HEX_DATA [3:0] <= RES_REG[119:116];
        5'b0000: HEX_DATA [3:0] <= RES_REG[115:112];
        5'b0000: HEX_DATA [3:0] <= RES_REG[111:108];
        5'b0000: HEX_DATA [3:0] <= RES_REG[107:104];
        5'b0000: HEX_DATA [3:0] <= RES_REG[103:100];
        5'b0000: HEX_DATA [3:0] <= RES_REG[99:96];
        5'b0000: HEX_DATA [3:0] <= RES_REG[95:92];
        5'b0000: HEX_DATA [3:0] <= RES_REG[91:88];
        ...
        default: HEX_DATA [3:0] <= RES_REG[119:116];
    endcase
            ...
            IDLE:if(RX_DATA_EN)begin
                if(RX_DATA_R[9] | RX_DATA_R[8] | ~HEX_FLG)begin
                    ...
                    begin
                        ...
                        ADDR <= RES_A0;
                        END_ADDR <= RES_A1;
                        DATA_REG <= {DATA_REG[11:0], DC_HEX_DATA};
